...
export const createSchool = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
...
export const getAllSchools = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
...
export const getAllSchoolsAllStudents = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {  
